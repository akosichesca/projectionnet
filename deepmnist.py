...
lshT = 4
lshD = 2
LSH_METRIC = lsh.L1_norm
LSH_FAMILY = lsh.L1HashFamily(10*radius,784)
LSH_TRAIN = 1000
lshproject = lsh.LSHIndex(LSH_FAMILY,lshT,lshD)
...
def random_projections(T,d,n):
  RandomPlanes = tf.truncated_normal([1,T,d,n], stddev=0.01)
  #RandomPlanes = tf.Variable(tf.random_normal([1,T,d,1], mean = 0, stddev = 1000))
  RandomPlanes2 = tf.tile(RandomPlanes,[FLAGS.BATCHSIZE,1,1,1])
